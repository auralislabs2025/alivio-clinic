export const translations = {
  en: {
    ...
    contactForm: {
      ...
      hoursValue: 'Mon–Sat: 9:00 AM – 1:00 PM and 3:00 PM – 6:00 PM',
      phoneLabel: 'Phone:',
      ...
      slotMorning: 'Morning — 9:00 AM to 1:00 PM',
      slotAfternoon: 'Afternoon — 3:00 PM to 6:00 PM',
      message: 'Message',
  ...
  ml: {
    ...
    contactForm: {
      ...
      hoursValue: 'തിങ്കൾ–ശനി: രാവിലെ 9:00 – 1:00, വൈകുന്നേരം 3:00 – 6:00',
      phoneLabel: 'ഫോൺ:',
      addressLabel: 'വിലാസം:',
      name: 'പേര്',
      phone: 'ഫോൺ',
      visitDate: 'സന്ദർശിക്കാൻ ആഗ്രഹിക്കുന്ന തീയതി',
      preferredTime: 'ഇഷ്ടപ്പെട്ട സമയം',
      slotMorning: 'രാവിലെ — 9:00 മുതൽ 1:00 വരെ',
      slotAfternoon: 'വൈകുന്നേരം — 3:00 മുതൽ 6:00 വരെ',
      message: 'സന്ദേശം',
